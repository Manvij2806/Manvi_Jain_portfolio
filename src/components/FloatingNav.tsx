...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Manvij2806', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/manvi-jain-457183339/', label: 'LinkedIn' },
    ...
    { icon: Mail, href: 'mailto:jainmanvi004@gmail.com', label: 'Email' },
  ];
