        ...
        <div className="about-sticky">
          ...
          >
            <div className="info-inner">
              ...
              <p>
                I’m Manvi Jain, a tech-driven frontend and Python developer passionate about building impactful and user-friendly web and AI solutions. I enjoy creating seamless interfaces, integrating Python-powered backends, and delivering real-world applications that combine performance with interactivity.
              </p>

              <p>
                Beyond coding, I love exploring UI/UX design, motion, and interactive experiences, blending creativity with technical precision. My goal is to develop applications that not only work efficiently but also provide an engaging user experience.
              </p>

              <p>
                Currently a 3rd-year B.Tech student in Electrical Engineering with Computer Science, experienced in Python, React Native, FastAPI, and Django. I’ve built projects from AI-driven telemedicine apps to real-time face recognition systems and am seeking internships to contribute to impactful web and AI solutions.
