      ...
      <div className="resume-container">
            ...
            {[
              {
                ...
                period: "2023 – 2027",
                detail: "Current GPA: 8.29",
              },
              {
                degree: "Higher Secondary (12th)",
                school: "Queen Victoria Girls Inter College",
                period: "2021 – 2022",
                detail: "72.8%",
              },
              {
        ...
        >
          ...
          <ul className="project-list">
            {[
              "- Breast Cancer Detection using YOLO + Ensemble CNN — in progress",
