...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    { img: linkedinLogo, link: "https://www.linkedin.com/in/manvi-jain-457183339/" },
    { img: gmailLogo, link: "jainmanvi004@gmail.com" },
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/Manvij2806" },
  ];

  const [typedRoles, setTypedRoles] = useState("");
  const rolesText = "BTech Student | Frontend & Python Enthusiast | Tech Explorer";
    ...
    <section id="home" className="hero">
      ...
      >
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">MANVI JAIN</span>
        ...
        Curious to learn new things while building smart systems and interactive web applications using Python and modern frameworks. 
        Passionate about software development, problem-solving, and impactful full-stack projects.
        </motion.p>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            ...
            { label: "💼 Focus", value: "Python, C++, DSA" },
