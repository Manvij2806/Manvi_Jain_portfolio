...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "jainmanvi004@gmail.com" },
    { icon: MapPin, label: "Location", value: "Agra, Utter Pradesh, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/Manvij2806" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/manvi-jain-457183339/" },
    { icon: Mail, url: "mailto:jainmanvi004@gmail.com" },
  ];
